...
class AddCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() => addCardViewModel.step == AddCardStep.CARD_NAME
        ? Scaffold(
                ...
                child: HeaderSafe(
                  child: Column(
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          SquareButton(text: "다음", onPressed: addCardViewModel.onClickCardNameDone, disabled: !addCardViewModel.available,),
                          Space(
