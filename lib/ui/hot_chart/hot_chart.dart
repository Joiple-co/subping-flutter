            ...
            child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return RankChartItem(
                      ...
                      serviceName: hotChartViewModel.chart.serviceRank[index].serviceName,
                      serviceSummary:
                          hotChartViewModel.chart.serviceRank[index].serviceSummary,
                      serviceSquareLogoUrl:
                          hotChartViewModel.chart.serviceRank[index].serviceSquareLogoUrl,
                      serviceTags: hotChartViewModel.chart.serviceRank[index].serviceTags);
                }),
          )),
    );
  }
