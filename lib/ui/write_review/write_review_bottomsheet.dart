...
class WriteReviewBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final writeReviewBottomSheetViewModel = Get.put(WriteReviewBottomSheetViewModel());
                    ...
                    children: [
                      ...
                      Center(
                        child: RatingBar.builder(
                            ...
                            onRatingUpdate: writeReviewBottomSheetViewModel.onChangeRating,
                      ))
                    ],
                  ),
                  Column(
                    children: [
                      Row(
                        children: [
                          ...
                          SquareButton(
                            text: "상세 리뷰하기",
                            onPressed: () => Get.toNamed('/writeReview', arguments: {
