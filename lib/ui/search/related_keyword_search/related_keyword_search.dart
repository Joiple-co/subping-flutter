...
class RelatedKeywordSearch extends StatelessWidget {
  
  final SearchModel searchResult;

  RelatedKeywordSearch({this.searchResult});   
            ...
            children: [
              ...
              Column(
                children: List.generate(
                    searchResult.serviceResult?.length ?? 0,
                    (index) => SearchItem(
                          serviceResult:
