...
class AutoCompleteServiceItem extends StatelessWidget {
  final ServiceModel serviceResult;
  final int itemIndex, matchedServiceNameIndex, matchedLength;  

  

  const AutoCompleteServiceItem({Key key, this.serviceResult, this.itemIndex, this.matchedServiceNameIndex, this.matchedLength }) : super(key: key);  // 여기도 index 추가했다;.
          ...
          Text.rich(SubpingTextSpan(children: [
            SubpingTextSpan(
                ...
                text: serviceResult.name
                    .substring(0, matchedServiceNameIndex)),
            SubpingTextSpan(
            ...
            SubpingTextSpan(
                fontSize: SubpingFontSize.title5,
                 fontWeight: FontWeight.bold,
                text: serviceResult.name.substring(
                    matchedServiceNameIndex + matchedLength)),
          ]))
        ],
      ),
    );
