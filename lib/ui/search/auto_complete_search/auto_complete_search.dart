...
import 'package:subping/ui/search/auto_complete_search/auto_complete_item.dart';
          ...
          children: [
            ...
            Column(
              children: List.generate(
                  searchViewModel.autoCompleteResult.serviceResult?.length ?? 0,
                  (index) => AutoCompleteItem(
                        serviceResult: searchViewModel.autoCompleteResult.serviceResult[index]
                      )),
            ),
            Space(
                  ...
                  return Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        //       text: tagResult.tag
                        //           .substring(0, tagResult.search.matchedIndex)),
                        //   SubpingTextSpan(
                        //       fontSize: SubpingFontSize.title5,
                        //       fontWeight: FontWeight.bold,
