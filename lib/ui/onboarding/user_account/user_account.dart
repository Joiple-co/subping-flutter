...
class UserAccount extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetX<UserAccountViewModel>(builder: (viewModel) => 
      Scaffold(
        resizeToAvoidBottomInset: false,
        body: HeaderSafe(
          child: HorizontalPadding(
            child: Column(children: [
              SubpingText(viewModel.currentTitle['preTitle']),
              SubpingText(viewModel.currentTitle['accent']),
              SubpingText(viewModel.currentTitle['postTitle']),
              ...
              Expanded(child: Column(children: [
                SubpingTextField(
                  ...
                  errorText: viewModel.emailError.value != "" ? viewModel.emailError.value : null,
                ),
                ...
                SubpingTextField(
                  ...
                  errorText: viewModel.passwordError.value != "" ? viewModel.passwordError.value : null,
                  obscureText: true,
                ),
                Space(size: Size.large30),
                SubpingTextField(
                  ...
                  errorText: viewModel.passwordCheckError.value != "" ? viewModel.passwordCheckError.value : null,
                  obscureText: true,
                )
              ],)),
              SqaureButton(text: "다음", onPressed: () => {}, 
